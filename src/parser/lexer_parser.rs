use crate::parser::{lexer, parsers};
use crate::parser::lexer::TokenType;
use crate::parser::parsers::enums::parse_enum_declaration;
use crate::parser::parsers::funcs::parse_fn;
use crate::parser::parsers::string_literals::parse_string_literal;
use crate::parser::parsers::variable::parse_variable;
    ...
    pub fn parse(&mut self) -> Trie {
        ...
        while let Some(token) = &self.current_token {
            let node = match token.token_type {
                ...
                _ => Err(SyntaxError::WrappedWithContextMessage(
                    "parsing".into(),
