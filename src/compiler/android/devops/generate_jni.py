...
def generate_jni_bindings_and_kotlin_composables(
    ...
    print(f"Rust JNI bindings and Kotlin functions returning Jetpack Compose composables have been generated and "
          f"written to '{rust_output_file}' and '{kotlin_output_file}'.")
